...
<div class="container">
    ...
    <form action="GakuseiCreateConfirm" method="post">
            ...
            <tr><th>県内外志望</th>
            	<td>
                    <select name="prefHope" required>
                    	<option value="どちらでも" <%= "どちらでも".equals(v_prefHope) ? "selected" : "" %>>どちらでも</option>
